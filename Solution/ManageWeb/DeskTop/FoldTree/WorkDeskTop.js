...
WorkDesktop.prototype = {
    ...
    _$maxWindow: false,
    _init: function () {
        this._headerHeight = $(".header_container").height();
    ...
    _initElementSize: function () {
        ...
        desktop._workAreaHeight = desktop._winHeight - desktop._headerHeight - $("#desktop_task_container").height()-10;
        desktop._$FunctionFrm.height(desktop._winHeight - desktop._headerHeight-4 );
        ...
        if (Math.abs(desktop._workAreaHeight - oldAreaHeight) > 10) {
            ...
            var autoPageSize = Math.ceil((desktop._workAreaHeight - 100) /23);
    ...
    openPageMenu: function (relModuleID, refImageUrl, refHref, refName) {
        ...
        if ($("#frame" + relModuleID).length != 0) {
            $("#frame" + relModuleID).attr("src", refHref);

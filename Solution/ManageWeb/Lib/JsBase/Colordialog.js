...
// 选颜色
function SelectColor(objValue,objSValue){
	var dEL = document.all(objValue);
	var sEL = document.all(objSValue);
	var url = "../../Lib/JsBase/selColor.htm?color="+encodeURIComponent(dEL.value);

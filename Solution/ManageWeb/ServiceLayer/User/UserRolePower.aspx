<%@ Page Title="" Language="C#" MasterPageFile="~/App_Master/EditPage.master" AutoEventWireup="true" CodeFile="UserRolePower.aspx.cs" Inherits="ServiceLayer_User_UserRolePower" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphContent" runat="Server">
    ...
    <table class="tblContent">
        ...
        <tr>
            ...
            <td>
                <WTF:MyDropDownList ID="dropModuleTypeID" AutoPostBack="true" runat="server" OnSelectedIndexChanged="dropModuleTypeID_SelectedIndexChanged"></WTF:MyDropDownList>
            </td>
            <td>用户信息:
            </td>
            <td>

...
public partial class SystemSafe_Power_CopyPowerList : SupportPageBase
{
    ...
    public override string Condition
    {
        get
        {
            return "it.UserTypeCID in {" + UserTypeList.ConvertListToString() + "}  and it.IsSuper=false and it.UserID!='" + CurrentUser.UserID + "' and  it.UserID!='" + UserID + "'";
    ...
    public void SaveInfo()
    {
        ...
        objUserRule.CopyUserPower(UserID, gdvContent.SelectedRowFirstKey, AuthorizeGroupID);

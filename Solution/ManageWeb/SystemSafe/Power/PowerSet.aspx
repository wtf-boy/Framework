<%@ Page Title="" Language="C#" MasterPageFile="~/App_Master/EditPage.master" AutoEventWireup="true" CodeFile="PowerSet.aspx.cs" Inherits="SystemSafe_Power_PowerSet" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cphScriptcbar" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function SavePower() {
            var isSucelss = false;
            $.ajax({
                url: "RolePowerHandler.ashx?<%=ModuleQuery %>",
                type: "Post",
                data: { "PowerModuleID": objUlTreeView.getSelectValue(), "RoleID": RoleID },
                dataType: "json",
                async: false,

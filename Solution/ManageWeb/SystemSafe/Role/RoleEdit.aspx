<%@ Page Title="" Language="C#" MasterPageFile="~/App_Master/EditPage.master" AutoEventWireup="true" CodeFile="RoleEdit.aspx.cs" Inherits="SystemSafe_Role_RoleEdit" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphTopToolbar" runat="Server">
    <WTF:MyToolbar ID="MyTopToolBar" runat="server" ModuleCode="SystemSafe_Role_RoleEdit"
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphContent" runat="Server">
    <table class="tblContent">
        ...
        <tr>
            ...
            <td>
                <WTF:MyDropDownList ID="dropAuthorizeGroupID" runat="server"></WTF:MyDropDownList>
            </td>
        </tr>

namespace WTF.Framework
{
    ...
    public class CRC32 : ICRC
    {
        ...
        public long ComputeCrc(uint oldCrc, byte bval)
        {
            return (long) (CrcTable[(int) ((IntPtr) ((oldCrc ^ bval) & 0xff))] ^ (oldCrc >> 8));
        }

        public override long GetCrc(int bval)
        {
            this.crc = CrcSeed;
            this.crc = CrcTable[(int) ((IntPtr) ((this.crc ^ bval) & ( 0xff)))] ^ (this.crc >> 8);
            this.crc ^= CrcSeed;
